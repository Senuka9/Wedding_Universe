...
<%
    ...
    try {
        PreparedStatement stmt = conn.prepareStatement(
            "SELECT * FROM decoration_services WHERE status = 'active' AND name LIKE ?"
        );
    ...
    <head>
        ...
        <style>
            ...
            .btn {
                ...
                z-index: 1;                 /* Keeps button above overlapping elements */
                pointer-events: auto;       /* Enables clicking if disabled */
    ...
    <body>
        ...
        <div class="navbar">
            <div class="nav-container">
                ...
                <div class="nav-links">
                    <a href="decoration_customer.jsp?season=all" class="nav-link">Back to All</a>
                </div>
            </div>
        </div>
        ...
        <main class="container">
            ...
            <p style="text-align:center; margin-top: 30px;">No matching decorations found.</p>
            <% } else { %>
