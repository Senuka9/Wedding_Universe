...
<%
    ...
    try {
        PreparedStatement stmt = conn.prepareStatement(
            "SELECT * FROM photography_services WHERE status = 'active' AND name LIKE ?"
        );
...
<html>
<head>
    <title>Photography Search Results</title>
           <style>
...
<div class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-links">
            <a href="photography_customer.jsp" class="nav-link">Back to Photography</a>
        </div>
    </div>
</div>
...
<main class="container">
    <% if (results.isEmpty()) { %>
        <p style="text-align:center; margin-top: 30px;">No matching services found.</p>
    <% } else { %>
