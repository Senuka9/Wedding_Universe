...
<%
    ...
    try {
        stmt = conn.prepareStatement("SELECT name FROM photography_services WHERE id = ? AND status = 'active'");
...
<head>
    <meta charset="UTF-8">
    <title>Book <%= name %> - Photography</title>
...
<div class="form-box">
        ...
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            try {
                ...
                PreparedStatement insert = conn.prepareStatement(
                    "INSERT INTO photography_bookings (service_id, service_name, customer_name, customer_phone, preferred_date, message) VALUES (?, ?, ?, ?, ?, ?)"
                );
    ...
    <div style="text-align:center; margin-top: 20px;">
        <a href="photography_customer.jsp">← Back to Photography</a>
    </div>
</div>
