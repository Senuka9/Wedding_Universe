...
<%
    ...
    try {
        PreparedStatement stmt = conn.prepareStatement(
            "SELECT * FROM beautician_services WHERE status = 'active' AND name LIKE ?"
        );
...
<html>
<head>
    <title>Beautician Search Results</title>
       <style>
...
<div class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-links">
            <a href="beautician_customer.jsp" class="nav-link">Back to Services</a>
        </div>
    </div>
</div>
